...
> Atualizacao etapa 38: novos assets oficiais devem ser publicados no Supabase
> Storage e registrados em `exercicio_midias`. Caminhos locais em
> `apps/mobile/assets/exercises` ficam como historico/fallback dos primeiros
> lotes.
