...
const MASCULINO_REGION_MASKS_RAW: BodyMapMask[] = [
  ...
  mask(
    ...
    "posterior",
    "esquerdo",
    path("M149 477 C181 445 232 454 254 498 C256 543 216 581 174 565 C138 551 124 510 149 477 Z"),
  ),
  mask(
    ...
    "posterior",
    "direito",
    path("M371 477 C339 445 288 454 266 498 C264 543 304 581 346 565 C382 551 396 510 371 477 Z"),
  ),
  mask(
  ...
  mask(
    ...
    "anterior",
    "esquerdo",
    path("M734 493 C706 462 647 474 633 518 C636 555 672 582 706 566 C740 550 754 519 734 493 Z"),
  ),
  mask(
    ...
    "anterior",
    "direito",
    path("M530 493 C558 462 617 474 631 518 C628 555 592 582 558 566 C524 550 510 519 530 493 Z"),
  ),
  mask(
...
const FEMININO_MASK_ADJUSTMENTS: Record<string, ShapeAdjust> = {
  ...
  "posterior-coxofemoral-direito": { posteriorDx: 2, dy: 2, rxScale: 0.96 },
