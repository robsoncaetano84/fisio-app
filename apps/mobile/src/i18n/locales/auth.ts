...
export const ptAuth: TranslationMap = {
  ...
  "auth.professionalSignupConselhoRegion": "Região do conselho",
  ...
  "auth.errorConselhoUfRequired": "Região/UF do conselho obrigatória",
...
export const enAuth: TranslationMap = {
  ...
  "auth.professionalSignupConselhoRegion": "Council region",
  ...
  "auth.errorConselhoUfRequired": "Council region/state is required",
...
export const esAuth: TranslationMap = {
  ...
  "auth.professionalSignupConselhoRegion": "Región del consejo",
  ...
  "auth.errorConselhoUfRequired": "La región/estado del consejo es obligatorio",
