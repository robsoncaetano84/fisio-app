...
export const ptClinical: TranslationMap = {
  ...
  "clinical.actions.markAllReferences": "Marcar todas",
  "clinical.actions.unmarkAllReferences": "Desmarcar todas",
  ...
  "clinical.patientPreview.title": "Prévia para o paciente",
  "clinical.patientPreview.description":
    "Revise exatamente o conteúdo que ficará disponível ao paciente. Rascunhos internos e observações profissionais não entram nesta prévia.",
  "clinical.patientPreview.reason": "Motivo da avaliação",
  "clinical.patientPreview.functionalDiagnosis": "Diagnóstico funcional",
  "clinical.patientPreview.clinicalFindings": "Achados clínicos",
  "clinical.patientPreview.conclusion": "Conclusão",
  "clinical.patientPreview.goals": "Objetivos",
  "clinical.patientPreview.treatmentPlan": "Plano de tratamento",
  "clinical.patientPreview.dischargeCriteria": "Critérios de alta",
  "clinical.patientPreview.weeklyFrequency":
    "Frequência semanal: {{value}}x",
  "clinical.patientPreview.durationWeeks": "Duração: {{value}} semana(s)",
  "clinical.patientPreview.empty":
    "Sem conteúdo clínico preenchido para exibir ao paciente.",
  "clinical.patientPreview.confirmPublish": "Confirmar publicação",
...
export const enClinical: TranslationMap = {
  ...
  "clinical.actions.markAllReferences": "Mark all",
  "clinical.actions.unmarkAllReferences": "Unmark all",
  ...
  "clinical.patientPreview.title": "Patient preview",
  "clinical.patientPreview.description":
    "Review exactly what will be available to the patient. Internal drafts and professional notes are not included in this preview.",
  "clinical.patientPreview.reason": "Evaluation reason",
  "clinical.patientPreview.functionalDiagnosis": "Functional diagnosis",
  "clinical.patientPreview.clinicalFindings": "Clinical findings",
  "clinical.patientPreview.conclusion": "Conclusion",
  "clinical.patientPreview.goals": "Goals",
  "clinical.patientPreview.treatmentPlan": "Treatment plan",
  "clinical.patientPreview.dischargeCriteria": "Discharge criteria",
  "clinical.patientPreview.weeklyFrequency":
    "Weekly frequency: {{value}}x",
  "clinical.patientPreview.durationWeeks": "Duration: {{value}} week(s)",
  "clinical.patientPreview.empty":
    "No clinical content filled in to show the patient.",
  "clinical.patientPreview.confirmPublish": "Confirm publication",
...
export const esClinical: TranslationMap = {
  ...
  "clinical.patientPreview.title": "Vista previa para el paciente",
  "clinical.patientPreview.description":
    "Revise exactamente el contenido que estará disponible para el paciente. Borradores internos y notas profesionales no entran en esta vista previa.",
  "clinical.patientPreview.reason": "Motivo de la evaluación",
  "clinical.patientPreview.functionalDiagnosis": "Diagnóstico funcional",
  "clinical.patientPreview.clinicalFindings": "Hallazgos clínicos",
  "clinical.patientPreview.conclusion": "Conclusión",
  "clinical.patientPreview.goals": "Objetivos",
  "clinical.patientPreview.treatmentPlan": "Plan de tratamiento",
  "clinical.patientPreview.dischargeCriteria": "Criterios de alta",
  "clinical.patientPreview.weeklyFrequency":
    "Frecuencia semanal: {{value}}x",
  "clinical.patientPreview.durationWeeks": "Duración: {{value}} semana(s)",
  "clinical.patientPreview.empty":
    "No hay contenido clínico completado para mostrar al paciente.",
  "clinical.patientPreview.confirmPublish": "Confirmar publicación",
