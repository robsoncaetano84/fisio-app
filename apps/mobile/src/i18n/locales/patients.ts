...
export const ptPatients: TranslationMap = {
  ...
  "patients.cycleAwaitingAnamnesis": "Aguardando anamnese",
  "patients.cycleInTreatment": "Em tratamento",
  "patients.cycleCompleted": "Ciclo concluído",
...
export const enPatients: TranslationMap = {
  ...
  "patients.cycleAwaitingAnamnesis": "Awaiting anamnesis",
  "patients.cycleInTreatment": "In treatment",
  "patients.cycleCompleted": "Cycle completed",
...
export const esPatients: TranslationMap = {
  ...
  "patients.cycleAwaitingAnamnesis": "Esperando anamnesis",
  "patients.cycleInTreatment": "En tratamiento",
  "patients.cycleCompleted": "Ciclo concluido",
