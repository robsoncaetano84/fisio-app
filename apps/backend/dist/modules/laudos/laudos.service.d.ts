...
export declare class LaudosService {
    ...
    private readonly laudoExameFisicoRepository;
    ...
    createExameFisico(createExameFisicoDto: CreateExameFisicoDto, usuarioId: string): Promise<LaudoExameFisico>;
    ...
    findExameFisicoByPaciente(pacienteId: string, usuarioId: string): Promise<LaudoExameFisico | null>;
    ...
    private registrarExameFisicoInicial;
    private findExameFisicoByPacienteId;
