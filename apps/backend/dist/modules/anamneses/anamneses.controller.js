...
const create_my_anamnese_dto_1 = require("./dto/create-my-anamnese.dto");
...
__decorate([
    ...
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_my_anamnese_dto_1.CreateMyAnamneseDto,
        usuario_entity_1.Usuario]),
    __metadata("design:returntype", void 0)
], AnamnesesController.prototype, "createMy", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)(usuario_entity_1.UserRole.ADMIN, usuario_entity_1.UserRole.USER),
    (0, throttler_1.Throttle)({ default: { ttl: 60, limit: 120 } }),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, update_anamnese_dto_1.UpdateAnamneseDto,
        usuario_entity_1.Usuario]),
    __metadata("design:returntype", void 0)
], AnamnesesController.prototype, "updateMy", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(usuario_entity_1.UserRole.ADMIN, usuario_entity_1.UserRole.USER),
    (0, throttler_1.Throttle)({ default: { ttl: 60, limit: 30 } }),
