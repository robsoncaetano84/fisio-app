...
let EvolucoesController = class EvolucoesController {
    ...
    create(createEvolucaoDto, usuario) {
    ...
    update(id, updateEvolucaoDto, usuario) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_evolucao_dto_1.CreateEvolucaoDto,
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, usuario_entity_1.Usuario]),
    __metadata("design:returntype", void 0)
], EvolucoesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, throttler_1.Throttle)({ default: { ttl: 60, limit: 30 } }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_evolucao_dto_1.UpdateEvolucaoDto,
        usuario_entity_1.Usuario]),
    __metadata("design:returntype", void 0)
], EvolucoesController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, usuario_entity_1.Usuario]),
    __metadata("design:returntype", void 0)
], EvolucoesController.prototype, "remove", null);
