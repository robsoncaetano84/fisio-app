...
exports.CreateCrmTables1771776000000 = void 0;
class CreateCrmTables1771776000000 {
    ...
    `);
        await queryRunner.query(`ALTER TABLE "crm_tasks" ADD COLUMN IF NOT EXISTS "ativo" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_crm_leads_stage" ON "crm_leads" ("stage")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_crm_leads_updated_at" ON "crm_leads" ("updated_at")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_crm_tasks_status" ON "crm_tasks" ("status")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_crm_tasks_due_at" ON "crm_tasks" ("due_at")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_crm_interactions_lead_id" ON "crm_interactions" ("lead_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_crm_interactions_occurred_at" ON "crm_interactions" ("occurred_at")`);
    }
...
exports.CreateCrmTables1771776000000 = CreateCrmTables1771776000000;
//# sourceMappingURL=1771776000000-CreateCrmTables.js.map