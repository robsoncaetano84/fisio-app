...
exports.CreateProfissionalPacienteVinculos1776200000000 = void 0;
class CreateProfissionalPacienteVinculos1776200000000 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`DROP INDEX IF EXISTS "UQ_VINCULO_ATIVO_POR_PACIENTE_USUARIO"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "UQ_VINCULO_ATIVO_POR_PACIENTE"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_VINCULO_PACIENTE_STATUS"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_VINCULO_PACIENTE_USUARIO_STATUS"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_VINCULO_PROFISSIONAL_STATUS"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "profissional_paciente_vinculos"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "profissional_paciente_vinculos_origem_enum"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "profissional_paciente_vinculos_status_enum"`);
    }
}
exports.CreateProfissionalPacienteVinculos1776200000000 = CreateProfissionalPacienteVinculos1776200000000;
//# sourceMappingURL=1776200000000-CreateProfissionalPacienteVinculos.js.map