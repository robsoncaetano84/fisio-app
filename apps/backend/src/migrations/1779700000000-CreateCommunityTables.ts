...
export class CreateCommunityTables1779700000000 implements MigrationInterface {
  name = 'CreateCommunityTables1779700000000';
  transaction = false;

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`);
    await queryRunner.query(
      `ALTER TYPE "usuarios_role_enum" ADD VALUE IF NOT EXISTS 'MODERATOR'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_sso_tokens" CASCADE`,
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_audit_logs" CASCADE`,
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_profile_badges" CASCADE`,
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "community_badges" CASCADE`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_moderation_reports" CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_resource_tags" CASCADE`,
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_resources" CASCADE`,
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS "community_post_tags" CASCADE`,
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "community_replies" CASCADE`);
    await queryRunner.query(`DROP TABLE IF EXISTS "community_posts" CASCADE`);
    await queryRunner.query(`DROP TABLE IF EXISTS "community_tags" CASCADE`);
    await queryRunner.query(
